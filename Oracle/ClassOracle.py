...
class Oracle(object):
    ...
    def connect(self, username, password, hostname, port, servicename):
        ...
        try:
            self.__init__(self, username, password, hostname, port, servicename)
            return self.db
        except:
            raise
...
if __name__ == "__main__":
    ...
    username = 'bileprod'
    password = 'bileprod'
    hostname = 'devdbirisfr.int.dns'
    port     = '1521'
    servicename = 'svcproddev2.world'
    try:
        oracle = Oracle()
        oracle.connect(username, password, hostname, port, servicename)
    except:
